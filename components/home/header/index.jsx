...
const Header = () => {
  ...
  return (
    <div className={classNames(inter.className, styles.header, 'flex items-center text-white transition-transform duration-300', show ? 'translate-y-0' : '-translate-y-full')}>
      <div className='text-[20px]/[20px] font-bold'>remit4me</div>
      <div className='ml-auto text-[16px]/[16px] font-medium'>About us</div>
      <div className='text-[16px]/[16px] font-medium mx-6 cursor-pointer' onClick={() => window.scrollTo({ top: 982, behavior: 'smooth' })}>
        Why choose us
      </div>
